...
|--- | :---: | :---: | :---: | :---: | :---: | :---: |
| Hirdetések blokkolása / Block ads | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :x: | :yellow_circle: |
| Nyomkövetők blokkolása / Block trackers | :x: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :x: | :yellow_circle: |
| Zavaró elemek blokkolása / Block annoyances | :x: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :x: | :x: |
| Adblock detekció blokkolása / Block adblock detectors | :x: | :yellow_circle: | :heavy_check_mark: | :heavy_check_mark: | :x: | :x: |
| Fejlett szabályok / Advanced rules | :x: | :yellow_circle: | :heavy_check_mark: | :heavy_check_mark: | :x: | :x: |
| Önpromóció blokkolása / Block self-promotion | :x: | :x: | :x: | :x: | :heavy_check_mark: | :x: |
| DNS szűrés / DNS filtering | :x: | :x: | :x: | :x: | :x: | :heavy_check_mark: |
...
:x: Nem támogatott / Not supported  
:yellow_circle: Részben támogatott / Partially supported  
:heavy_check_mark: Támogatott / Supported  
